...
Swal.fire({
    ...
    confirmButtonText: 'Aceptar',
    allowOutsideClick: false,
    html: '<h1 style="text-align:center;margin-bottom:15px;font-size:30px;font-weight: bold;">CLAVE INCORRECTA</h1><br><p style="text-align:center;">La clave que recibiste v&iacute;a SMS debe ser de una longitud de 18 caracteres</p>'
});
</script>
